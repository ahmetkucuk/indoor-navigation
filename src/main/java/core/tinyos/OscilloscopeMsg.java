...
public class OscilloscopeMsg extends net.tinyos.message.Message {
     ...
     * message type name and the non-indexed field values.
     */
    public LightIntensityResponse toLightIntensityResponse() {
        LightIntensityResponse response = new LightIntensityResponse();
        try {
        ...
        try {
            ...
            for (int i = 0; i < NUMBER_OF_READINGS; i++) {
                readings[i] = getElement_readings(i) & 0xffff;
            }
